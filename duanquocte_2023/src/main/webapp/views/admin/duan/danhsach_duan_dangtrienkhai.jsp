    ...
    function validateForm() {
    	  ...
    	  for (var i = 0; i < checkboxes.length; i++) {
    	    if (checkboxes[i].checked) {
    	      ...
    	      if ( currentValue[26] !== quy || currentValue[27] !== nam) {
...
function updateCheckboxValue() {
	  ...
	  for (var i = 0; i < checkboxes.length; i++) {
	    if (checkboxes[i].checked) { // Chỉ cập nhật giá trị cho những ô checkbox được chọn
	      ...
	      currentValue[21] + "||" + currentValue[22] + "||" + currentValue[23] + "||" + currentValue[24] + "||"  + currentValue[25] + "||" +  quy + "||" + nam;
	    }
