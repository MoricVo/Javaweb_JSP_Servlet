								...
								<tbody>
									...
									<tr>
										...
										<th class="text-nowrap" style="font-weight: 600; color: black">Tổng
											vốn thực hiện:</th>
										<td>${c.tongVonThucHien} ${c.donvitiente.tenDonViTienTe}</td>
									...
									<tr>
										<th class="text-nowrap" style="font-weight: 600; color: black">Vốn
											tài trợ:</th>
										<td style="border-right: 2px solid;">${c.vonTaiTro} ${c.donvitiente.tenDonViTienTe}</td>

										<th class="text-nowrap" style="font-weight: 600; color: black">Vốn
											vay:</th>
										<td>${c.vonVay} ${c.donvitiente.tenDonViTienTe}</td>
									...
									<tr>
										<th class="text-nowrap" style="font-weight: 600; color: black">Vốn
											khác:</th>
										<td style="border-right: 2px solid;">${c.vonKhac}
											${c.donvitiente.tenDonViTienTe}</td>

										<th class="text-nowrap" style="font-weight: 600; color: black">Vốn
											đối ứng:</th>
										<td>${c.vonDoiUng} ${c.donvitiente.tenDonViTienTe}</td>
